...
| **W5** bounded search | **Done on fpv2+liq_v4 — no RankIC unlock** | best hyper test **0.2695**; contract false (`CPU_W5_FPV2_LIQV4_2K_20260724.md`) |
...
| **In flight** | 60-day shadow loop armed for E7 (`scripts/ml_daily_shadow.sh --loop 60 --wait`) |
