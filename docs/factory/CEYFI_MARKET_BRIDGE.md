# Ceyfi Market ↔ Chime bridge (Phase 1)
...
- With `CHIME_API_BASE=https://…chime`: proxies Chime after `POST /api/v1/auth/demo`
...
CHIME_DEMO_TELEGRAM_ID=123456789       # must be on Chime DASH_DEMO_TELEGRAM_IDS
```
...
- Chime dash is not the consumer invest host
