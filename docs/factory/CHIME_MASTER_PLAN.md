...
| Factory `repo_score` | Still climb via [CHIME_HORIZON.md](CHIME_HORIZON.md) — quality commits only |
...
| `CHIME_HORIZON.md` | Score band 2K–3K; update §1 one-liner to cake+cherry |
