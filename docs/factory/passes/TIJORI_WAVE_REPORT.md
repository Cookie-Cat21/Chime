...
**Range:** `a802cb7` … wave 55 (post-100% harden → soft ~100)
...
| Improve-loop / CI on touched paths | ongoing — wave 55 post-100% harden → soft ~100 loops |
