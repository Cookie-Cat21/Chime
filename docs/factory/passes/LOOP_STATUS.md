...
| Commits ahead of `main` | **308+** (pre-this-commit) |
...
| Wave 91 landed | **FIXED** — rule bool numeric coercion; CLI arg soft-accepts; disclosure watermark conflict; health poller merge; alert lookup NFA; CSE numeric payload bool reject; brief prompt delimiters |
