...
| Metric | Value |
|---|---|
| Waves completed | **55** (`wave` / `waveN` / `wN` through w55) |
| This status push | **w56** (docs only) |
...
1. Spawn w56+ harden/ops lanes inside product fences (not cov padding).
