...
| Metric | Value |
|---|---|
| Waves completed | **35** (`wave` / `waveN` / `wN` through w35) |
| This status push | **w36** (docs only) |
| Commits ahead of `main` | **192** |
...
1. Spawn w36+ harden/ops lanes inside product fences (not cov padding).
