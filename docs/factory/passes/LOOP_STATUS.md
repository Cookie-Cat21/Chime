...
| Metric | Value |
|---|---|
| Waves completed | **21** (`wave` / `waveN` / `wN` through w21) |
| This status push | **w22** (docs only) |
| Commits ahead of `main` | **159** |
...
1. Spawn w22+ harden/ops lanes inside product fences (not cov padding).
