...
## Cycle — 2026-07-24 remaining fpv2 families

- Models: `hgb_weighted`, `hgb_domain`, `xgb_domain`, `lgb_lmt`, `lgb_domain`, `qlib_lgb_native`.
- Best nested RankIC: `lgb_lmt` **0.2814** (−0.0047 vs frozen 0.2861).
- Selective best: `hgb_weighted` 0.738 / 0.636 / 61 — SuccessContract **NOT MET**.
- Evidence: `REMAINING_FAMILIES_NESTED_20260724.md`.
- Next: near-miss disagreement nest (`xgb_two_stage`+`xgb_lmt`+`hgb_lmt`) in flight.

## Cycle — 2026-07-24 near-miss disagreement
...
## Cycle — 2026-07-24 liq_v4

- Sample retention **87.3%** (439k) — first W2 filter to clear 100k floor.
...
## W5 unlock — 2026-07-24 fpv2+liq_v4
