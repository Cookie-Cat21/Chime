# Goal A wave6 abs+matmed+fpv3 — 2026-07-24T22:40:01.480474+00:00

- `cpu-sel-abs-matmed-fpv3` `hgb_bagged.selective_gates.json` contract=False prec=0.9039 LCB=0.8670 emits=229
- `cpu-metalabel-abs-matmed-fpv3` `hgb_bagged.selective_metalabel_rich.json` contract=False prec=0.8514 LCB=0.8079 emits=222
