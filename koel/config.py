...
class Settings:
    ...
    # Floor is 5s — CSE has no public quote WebSocket; this is near-realtime
    # via bulk tradeSummary (one HTTP call / tick), not order-book hammering.
    ...
    def from_env(cls, *, require_token: bool = True) -> Settings:
        ...
        return cls(
            ...
            poll_interval_seconds=_positive_float_at_least(
                "POLL_INTERVAL_SECONDS", 5.0, _MIN_POLL_INTERVAL_SECONDS
            ),
            poll_jitter_seconds=_nonneg_float("POLL_JITTER_SECONDS", 1.0),
