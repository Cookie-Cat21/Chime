...
from koel.circuit import CircuitBreaker, CircuitOpenError
...
DEFAULT_HEADERS = {
    "User-Agent": (
        "Mozilla/5.0 (compatible; KoelBot/0.1; +https://github.com/ArdenoStudio/Koel; "
...
class CSEClient:
    ...
    async def fetch_company_directors(self, symbol: str) -> list[dict[str, Any]]:
        ...
        """
        from koel.extractors.cse_directors import merge_cse_board
