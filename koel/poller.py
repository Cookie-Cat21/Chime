...
from koel.health import brief_queue_health_hint
...
DELIVERY_OK_LEDGER_ENV = "KOEL_DELIVERY_OK_LEDGER"
...
class Poller:
    ...
    def _delivery_ok_ledger_path_from_env(self) -> Path | None:
        ...
        return Path("/tmp/koel") / f"delivery-ok-{digest}.jsonl"
    ...
    def _schedule_metrics_job(self, disclosure_id: int, symbol: str) -> None:
        ...
        from koel.metrics import metrics_enabled
