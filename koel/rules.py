...
def evaluate_xd_soon_rules(
    *,
    ...
    from koel.dividends import colombo_today, xd_within_horizon
...
def evaluate_xd_digest_rules(
    *,
    ...
    from koel.dividends import colombo_today, iso_week_key, xd_within_horizon
    from koel.domain import MARKET_SYMBOL
